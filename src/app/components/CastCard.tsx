    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={castInfoStyle as any}>
            <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M10.5 5C10.5 7.875 6.375 10 6 10C5.625 10 1.5 7.875 1.5 5C1.5 3 2.75 2 4 2C5.25 2 6 2.75 6 2.75C6 2.75 6.75 2 8 2C9.25 2 10.5 3 10.5 5Z" stroke="white" stroke-opacity="0.3"/>
            </svg>
            <p style={castInfoTextStyle as any}>
          ...
          <div style={castInfoStyle as any}>
            <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M2 6C2 8.20914 3.79086 10 6 10C7.26319 10 8.4152 9.41446 9.15577 8.5M10 6C10 3.79086 8.20914 2 6 2C4.73681 2 3.5848 2.58554 2.84424 3.5M2.5 2V4H4.5M9.50592 10V8H7.50592" stroke="white" stroke-opacity="0.3"/>
            </svg>
            <p style={castInfoTextStyle as any}>
